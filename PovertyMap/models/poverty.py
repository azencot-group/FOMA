...
def getTrainDataLoader(args, device):
    kwargs = {'no_nl': False,
              'fold': args.fold,
    ...
    train_loaders = DataLoader(train_sets, shuffle=False,  # Shuffle training dataset
                               sampler=None, collate_fn=train_sets.collate, batch_size=256, **kwargs)
